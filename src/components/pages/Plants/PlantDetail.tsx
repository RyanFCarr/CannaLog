  ...
  return (
    ...
    >
      ...
      <Autocomplete
        ...
        renderInput={(params) => (
          <TextField {...params} label="Grow Type" {...textFieldProps} />
        )}
      ...
      <Autocomplete
        options={["LED", "HPS"]}
        renderInput={(params) => (
          <TextField {...params} label="Lighting Type" {...textFieldProps} />
        )}
      ...
      <Autocomplete
        ...
        renderInput={(params) => (
          <TextField
            ...
            helperText={
              lightingSchedOptions[0] === "" ? "Choose a Grow Type" : ""
            }
            {...textFieldProps}
          />
        )}
      ...
      <Autocomplete
        ...
        renderInput={(params) => (
          <TextField {...params} label="Grow Medium" {...textFieldProps} />
        )}
    ...
    <Box display="flex" justifyContent="space-around">
      ...
      {viewMode === ViewMode.VIEW && (
        <Button
          variant="contained"
          startIcon={<AddIcon />}
          onClick={() => navigate(`/plants/${plantId}/growlogs/add`)}
        >
          Add a Grow Log
        </Button>
      )}
